...
Ref: Li, et al., Nature (2023)

## Direct-write photonic integrated circuits in phase-change materials
![]({{ site.url }}{{ site.baseurl }}/images/respic/pcm.png){: style="width: 250px; float: left; margin: 0px  10px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/wse2.jpg){: style="width: 250px; float: left; margin: 0px  10px"}
...
Ref: Ripin, et al., Nature Nanotechnology (2023) 
Peng, et al., Nature Communications (2022)

## Photonics Sensors
![]({{ site.url }}{{ site.baseurl }}/images/respic/seira.png){: style="width: 250px; float: left; margin: 0px  10px"}
